    ...
    <section className="relative h-screen bg-black text-white flex items-center justify-center">
      ...
      <div className="z-20 text-center px-6 max-w-4xl">
        ...
        <p className="text-lg md:text-xl mb-6">
          We are <span className="text-[#fdb713]">Trihood Films</span>, a creative agency dedicated to bringing stories to life. We craft
          content that resonates, connects emotionally, and transforms simple ideas into
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <Link
            href="/contact"
            className="relative inline-block px-8 py-3 font-semibold text-black bg-white rounded-full group overflow-hidden transition-all duration-300 hover:text-white"
          >
            <span className="absolute inset-0 w-full h-full bg-[#fdb713] scale-0 group-hover:scale-100 transition-transform duration-300 ease-out origin-center rounded-full z-0" />
